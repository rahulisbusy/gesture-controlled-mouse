...
class Controller:
    ...
    prev_hand = None
    pinch_threshold = 0.3
    # Sensitivity multiplier for cursor movement. Increase >1.0 to speed up, <1.0 to slow down.
    ...
    def changesystembrightness():
        ...
        try:
            # Modern screen-brightness-control API
            ...
            sbcontrol.set_brightness(int(100 * currentBrightnessLv))
    ...
    def get_position(hand_result):
        ...
        if distsq <= 25:
            ...
            ratio = 2.1
        # apply sensitivity multiplier so the user can tune cursor speed easily
        x , y = x_old + delta_x*ratio*Controller.mouse_sensitivity , y_old + delta_y*ratio*Controller.mouse_sensitivity
        return (x,y)
